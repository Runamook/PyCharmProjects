...
def set(cmd, data, input_vars):
    with MeterBase(input_vars) as m:
        m.sendcmd_and_decode_response(b"/" + b"?" + input_vars["meter"]["meterNumber"].encode() + b"!\r\n")
...
def new_set(what, input_vars):
    ...
    set("W5", f"{obis}({value})(00000000)", input_vars)
